...
const iconSource = {
  ...
  Rating12Icon: Path.resolve(__dirname, "../static/icons/svgs/rating-12.svg"),
  Rating12aIcon: Path.resolve(__dirname, "../static/icons/svgs/rating-12a.svg"),
  Rating15Icon: Path.resolve(__dirname, "../static/icons/svgs/rating-15.svg"),
  Rating18Icon: Path.resolve(__dirname, "../static/icons/svgs/rating-18.svg"),
  RatingpgIcon: Path.resolve(__dirname, "../static/icons/svgs/rating-pg.svg"),
  Ratingr18Icon: Path.resolve(__dirname, "../static/icons/svgs/rating-r18.svg"),
  RatinguIcon: Path.resolve(__dirname, "../static/icons/svgs/rating-u.svg"),
};
